...
M15 (simulation replay system) is complete in the working tree and is intended to be captured by the next checkpoint commit. Earlier checkpoints:
...
- `.venv313\Scripts\python.exe -m pytest -q`: 179 passed.
