...
DISPLAY_NAMES = {
    ...
    "descent_rate": "Descent rate (m/s)",
    "hover_power": "Hover power (W)",
    "climb_power": "Climb power (W)",
    "descent_power": "Descent power (W)",
    "horizontal_power": "Horizontal power (W)",
...
class PropertyPanel(QScrollArea):
    ...
    def set_object(self, item: MapObject) -> None:
        ...
        for field in fields(item):
            if field.name in {"assigned_tasks", "waypoints", "points", "holes"}:
                continue
